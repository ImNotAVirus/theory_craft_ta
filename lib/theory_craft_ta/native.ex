defmodule TheoryCraftTA.Native do
  ...
  def overlap_midprice(_high, _low, _period), do: error()
  ...
  def overlap_midprice_state_init(_period), do: error()
  def overlap_midprice_state_next(_state, _high, _low, _is_new_bar), do: error()
