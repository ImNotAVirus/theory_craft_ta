defmodule TheoryCraftTA.Native do
  ...
  def overlap_ht_trendline(_data), do: error()
  ...
  def overlap_ht_trendline_state_init(), do: error()
  def overlap_ht_trendline_state_next(_state, _value, _is_new_bar), do: error()
